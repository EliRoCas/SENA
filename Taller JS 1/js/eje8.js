...
let num1_usu, num2_usu, num3_usu, maximo, minimo, promedio;

num1_usu = parseInt(prompt('Ingrese su primer número '));
num2_usu = parseInt(prompt('Ingrese su segundo número '));
num3_usu = parseInt(prompt('Ingrese su tercer número '));

maximo = Math.max(num1_usu, num2_usu, num3_usu);

minimo = Math.min(num1_usu, num2_usu, num3_usu);

promedio = (num1_usu + num2_usu + num3_usu) / 3;
...
let text_mayuscula, text_minuscula;
text_mayuscula = "";
text_minuscula = "";
